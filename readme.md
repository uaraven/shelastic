...
Latest version of shelastic is 0.3, binaries compiled for `amd64` architecture can be downloaded [here](releases/tag/v0.3). It includes pre-built binaries for Linux, MacOS and Windows. Note that Windows binary is untested. 
